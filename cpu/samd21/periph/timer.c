...
{
    ISR_ENTER();
    if (TIMER_0_DEV.INTFLAG.vec.MC) {
        config[TIMER_0].cb(TIMER_0_DEV.INTFLAG.vec.MC);
        TIMER_0_DEV.INTFLAG.vec.MC = TIMER_0_DEV.INTFLAG.vec.MC;
    }
    ISR_EXIT();
}
#endif /* TIMER_0_EN */
...
{
    ISR_ENTER();
    if (TIMER_1_DEV.INTFLAG.vec.MC) {
        config[TIMER_1].cb(TIMER_1_DEV.INTFLAG.vec.MC);
    }
    ISR_EXIT();
}
#endif /* TIMER_1_EN */
...
{
    ISR_ENTER();
    if (TIMER_2_DEV.INTFLAG.vec.MC) {
        config[TIMER_2].cb(TIMER_2_DEV.INTFLAG.vec.MC);
    }
    ISR_EXIT();
}
#endif /* TIMER_2_EN */
